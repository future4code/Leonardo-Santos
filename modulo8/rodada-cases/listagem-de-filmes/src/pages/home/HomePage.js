import { trend,findMovie } from '../../constants/urls'
import { useRequestData } from '../../hooks/useRequestData'
import { Card, H1, FilterP, ContainerP, ContainerH1, ContainerCheck, ContainerSection2, Data, DivImage,  Header, Image, InfoCard, Main, Section1, Section2, Section3, SenctionFind } from './styled'
import { BasicPag } from '../../components/pag'
import React, { useState } from 'react'
import { TextField } from '@mui/material'
import Checkbox from '@mui/material/Checkbox';
import { useNavigate } from "react-router-dom";
import { goToDetailsPageMovie, goToDetailsPageTV } from '../../router/coordinator'
      ...
      <>
         ...
         <Main>
            <Section1>
               ...
               <ContainerH1>
                  <H1>Milhões de filmes, séries e pessoas<br/> para descobrir. Explore já.</H1>
               </ContainerH1> 
               
               <ContainerP>
                  <FilterP>Filtre por:</FilterP>
               </ContainerP>
